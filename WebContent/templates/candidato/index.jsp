...
<form action="/templates/candidato/result-pesquisa.jsp" method="POST">
...
<form action="gerar-pdf" method="POST">
  ...
  <button type="POST" class="btn btn-primary" type="submit">Gerar Curriculo</button>
